# Generated by Django 4.2.10 on 2025-06-12 08:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(help_text='Physical address of the farm', max_length=500)),
                ('location', models.TextField(blank=True, help_text='Additional location description', null=True)),
                ...
                ('photo', models.ImageField(blank=True, help_text='Photo of the farm', null=True, upload_to='farms/photos/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='routes', to=settings.AUTH_USER_MODEL)),
            ],
            options={
